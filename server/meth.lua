...
RegisterServerEvent('ps-drugprocessing:pickedUpHydrochloricAcid', function()
	...
	if Player.Functions.AddItem("hydrochloric_acid", 1) then
		TriggerClientEvent('inventory:client:ItemBox', src, exports.ox_inventory:Items()["hydrochloric_acid"], "add")
	end
end)
...
RegisterServerEvent('ps-drugprocessing:pickedUpSodiumHydroxide', function()
	...
	if Player.Functions.AddItem("sodium_hydroxide", 1) then 
		TriggerClientEvent('inventory:client:ItemBox', src, exports.ox_inventory:Items()["sodium_hydroxide"], "add")
	end
end)
...
RegisterServerEvent('ps-drugprocessing:pickedUpSulfuricAcid', function()
	...
	if Player.Functions.AddItem("sulfuric_acid", 1) then
		TriggerClientEvent('inventory:client:ItemBox', src, exports.ox_inventory:Items()["sulfuric_acid"], "add")
	end
end)
		...
		if Player.Functions.RemoveItem("hydrochloric_acid", Config.MethProcessing.HydAcid) then
			if Player.Functions.RemoveItem("sodium_hydroxide", Config.MethProcessing.SodHyd) then
				if Player.Functions.AddItem("liquidmix", 1) then
					TriggerClientEvent('inventory:client:ItemBox', src, exports.ox_inventory:Items()["sulfuric_acid"], "remove", Config.MethProcessing.SulfAcid)
					TriggerClientEvent('inventory:client:ItemBox', src, exports.ox_inventory:Items()["hydrochloric_acid"], "remove", Config.MethProcessing.HydAcid)
					TriggerClientEvent('inventory:client:ItemBox', src, exports.ox_inventory:Items()["sodium_hydroxide"], "remove", Config.MethProcessing.SodHyd)
					TriggerClientEvent('inventory:client:ItemBox', src, exports.ox_inventory:Items()["liquidmix"], "add", 1)
				else
...
RegisterServerEvent('ps-drugprocessing:processTempUp', function()
	...
	if Player.Functions.RemoveItem("liquidmix", 1) then
		if Player.Functions.AddItem("chemicalvapor", 1) then
			TriggerClientEvent('inventory:client:ItemBox', src, exports.ox_inventory:Items()["liquidmix"], "remove")
			TriggerClientEvent('inventory:client:ItemBox', src, exports.ox_inventory:Items()["chemicalvapor"], "add")
		else
...
RegisterServerEvent('ps-drugprocessing:processTempDown', function()
	...
	if Player.Functions.RemoveItem("chemicalvapor", 1) then
		if Player.Functions.AddItem("methtray", 1) then
			TriggerClientEvent('inventory:client:ItemBox', src, exports.ox_inventory:Items()["chemicalvapor"], "remove")
			TriggerClientEvent('inventory:client:ItemBox', src, exports.ox_inventory:Items()["methtray"], "add")
		else
...
RegisterServerEvent('ps-drugprocessing:processMeth', function()
	...
	if Player.Functions.RemoveItem("methtray", 1) then
		if Player.Functions.AddItem("meth", Config.MethProcessing.Meth) then
			TriggerClientEvent('inventory:client:ItemBox', src, exports.ox_inventory:Items()["methtray"], "remove")
			TriggerClientEvent('inventory:client:ItemBox', src, exports.ox_inventory:Items()["meth"], "add", Config.MethProcessing.Meth)

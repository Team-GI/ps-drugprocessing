...
RegisterServerEvent('ps-drugprocessing:pickedUpCocaLeaf', function()
	...
	if Player.Functions.AddItem("coca_leaf", 1) then 
		TriggerClientEvent('inventory:client:ItemBox', src, exports.ox_inventory:Items()["coca_leaf"], "add")
...
RegisterServerEvent('ps-drugprocessing:processCocaLeaf', function()
	...
	if Player.Functions.RemoveItem('coca_leaf', Config.CokeProcessing.CokeLeaf) then
		if Player.Functions.AddItem('coke', Config.CokeProcessing.ProcessCokeLeaf) then
			TriggerClientEvent("inventory:client:ItemBox", source, exports.ox_inventory:Items()['coca_leaf'], "remove", Config.CokeProcessing.CokeLeaf)
			TriggerClientEvent("inventory:client:ItemBox", source, exports.ox_inventory:Items()['coke'], "add", Config.CokeProcessing.ProcessCokeLeaf)
	...
	if Player.Functions.RemoveItem('coke', Config.CokeProcessing.Coke) then
		if Player.Functions.RemoveItem('bakingsoda', Config.CokeProcessing.BakingSoda) then
			if Player.Functions.AddItem('coke_small_brick', Config.CokeProcessing.SmallCokeBrick) then
				TriggerClientEvent("inventory:client:ItemBox", source, exports.ox_inventory:Items()['coke'], "remove", Config.CokeProcessing.Coke)
				TriggerClientEvent("inventory:client:ItemBox", source, exports.ox_inventory:Items()['bakingsoda'], "remove", Config.CokeProcessing.BakingSoda)
				TriggerClientEvent("inventory:client:ItemBox", source, exports.ox_inventory:Items()['coke_small_brick'], "add", Config.CokeProcessing.SmallCokeBrick)
...
RegisterServerEvent('ps-drugprocessing:processCocaBrick', function()
	...
	if Player.Functions.RemoveItem('coke_small_brick', Config.CokeProcessing.SmallBrick) then
		if Player.Functions.AddItem('coke_brick', Config.CokeProcessing.LargeBrick) then
			TriggerClientEvent("inventory:client:ItemBox", src, exports.ox_inventory:Items()['coke_small_brick'], "remove", Config.CokeProcessing.SmallBrick)
			TriggerClientEvent("inventory:client:ItemBox", src, exports.ox_inventory:Items()['coke_brick'], "add", Config.CokeProcessing.LargeBrick)
